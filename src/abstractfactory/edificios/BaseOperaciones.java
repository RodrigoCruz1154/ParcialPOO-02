...
public class BaseOperaciones implements Edificio {
    ...
    int oroRealJ2 = 0, maderaRealJ2 = 0, metalRealJ2 = 0;
...
//JUGADOR 2
                ...
                boolean cierto = true;
                while (cierto) { // base de operaciones para jugador 1
                    if (player2.equals("Earth")) {
                        ...
                        while (turno) {
                            ...
                            if (caso == 1) {
                                ...
                                base.setOro(oroActual);
                                oroRealJ2 = base.getOro();
                                base.setMetal(metalActual);
                                metalRealJ2 = base.getMetal();
                                base.setMadera(maderaActual);
                                maderaRealJ2 = base.getMadera();

                                if (oroRealJ2 > 300 && metalRealJ2 > 100 && maderaRealJ2 > 140) {
                                    centroE.buildEdificio();
                                    if (accion == 1) {
                                        centroE.usoEdificio(0);
                                        entrenamientos.add(centroE);
                            ...
                            if (caso == 2) {
                                ...
                                if (oroRealJ2 > 300 && metalRealJ2 > 80 && maderaRealJ2 > 100) {
                                    taller.buildEdificio();
                                    if (accion == 1) {
                                        taller.usoEdificio(0);
                                        talleres.add(taller);
                            ...
                            if (caso == 3) {
                                ...
                                if (oroRealJ2 > 250 && metalRealJ2 > 100 && maderaRealJ2 > 100) {
                                    taller.buildEdificio();
                                    if (accion == 1) {
                                        torreta.usoEdificio(0);
                                        torretas.add(torreta);
